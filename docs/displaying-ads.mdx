...
```js
import { AppOpenAd, TestIds, AdEventType } from 'new-react-native-google-mobile-ads';
...
```js
import { InterstitialAd, TestIds, AdEventType } from 'new-react-native-google-mobile-ads';
