...
This will also show an IDFA explainer message. If you don't want to show an explainer message you can show the ATT alert [manually](https://docs.page/invertase/new-react-native-google-mobile-ads#app-tracking-transparency-ios).
...
```js
import mobileAds, { AdsConsent, AdsConsentStatus } from 'new-react-native-google-mobile-ads';
...
```js
import { AdsConsent, AdsConsentDebugGeography } from 'new-react-native-google-mobile-ads';
